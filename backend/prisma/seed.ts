...
async function main() {
  ...
  const v1 = await prisma.movie.create({
    data: {
      ...
      isPopular: true,
      isDeleted: false,
      synopsis: "O confronto final contra Thanos.",
      duration: "181 min",
    },
  });
  const v2 = await prisma.movie.create({
    data: {
      ...
      isPopular: false,
      isDeleted: false,
      synopsis: "Robôs gigantes vs Monstros gigantes.",
      duration: "131 min",
    },
  });
  await prisma.movie.create({
    data: {
      ...
      isPopular: true,
      isDeleted: false,
      synopsis: "A realidade é uma simulação.",
      duration: "136 min",
    },
  });
  ...
  const c1 = await prisma.movie.create({
    data: {
      ...
      isPopular: true,
      isDeleted: false,
      synopsis: "Dois policiais do Ceará e de São Paulo resolvem um caso.",
      duration: "97 min",
    },
  });
  await prisma.movie.create({
    data: {
      ...
      isPopular: false,
      isDeleted: false,
      synopsis: "Dois amigos tentam comprar bebida para uma festa.",
      duration: "113 min",
    },
  });
  ...
  const t1 = await prisma.movie.create({
    data: {
      ...
      isPopular: false,
      isDeleted: false,
      synopsis: "Investigadores paranormais ajudam uma família.",
      duration: "112 min",
    },
  });
  const t2 = await prisma.movie.create({
    data: {
      ...
      isPopular: true,
      isDeleted: false,
      synopsis: "Uma jovem é possuída por uma entidade misteriosa.",
      duration: "122 min",
    },
  });
  const t3 = await prisma.movie.create({
    data: {
      ...
      isPopular: false,
      isDeleted: false,
      synopsis: "Um festival de verão sueco se transforma em pesadelo.",
      duration: "148 min",
    },
  });
  ...
  await prisma.movie.create({
    data: {
      title: "Filme Fantasma Deletado",
      genres: "Ação",
      isPopular: true,
      isDeleted: true,
      synopsis: "Este filme nunca deve aparecer.",
      duration: "120 min",
    },
  });
  ...
  await prisma.movie.create({
    data: {
      ...
      isDeleted: false,
      synopsis:
        "Após a morte da avó, uma família começa a descobrir segredos sombrios sobre seus ancestrais.",
      duration: "127 min",
    },
  });
  ...
  await prisma.movie.create({
    data: {
      ...
      isDeleted: false,
      synopsis:
        "Os investigadores paranormais Ed e Lorraine Warren viajam para a Inglaterra para ajudar uma mãe solteira.",
      duration: "134 min",
    },
  });
  ...
  await prisma.movie.create({
    data: {
      ...
      isDeleted: false,
      synopsis:
        "Um jovem fotógrafo descobre um segredo sombrio ao visitar os pais da sua namorada.",
      duration: "104 min",
    },
  });
  ...
  await prisma.movie.create({
    data: {
      ...
      isDeleted: false,
      synopsis:
        "Na Nova Inglaterra de 1630, uma família de colonos é dizimada por forças de bruxaria e magia negra.",
      duration: "92 min",
    },
  });
  ...
  await prisma.movie.create({
    data: {
      ...
      isDeleted: false,
      synopsis:
        "Uma família precisa lutar para sobreviver em silêncio absoluto para não ser caçada por criaturas cegas.",
      duration: "90 min",
    },
  });
